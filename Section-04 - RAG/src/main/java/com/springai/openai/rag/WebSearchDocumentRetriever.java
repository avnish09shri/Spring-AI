...
public class WebSearchDocumentRetriever implements DocumentRetriever {
    ...
    public WebSearchDocumentRetriever(int resultLimit, RestClient.Builder clientBuilder) {
        Assert.notNull(clientBuilder, "client can't be null");
        String apiKey = System.getenv(TAVILY_API_KEY);
        Assert.hasText(apiKey, "Environment Variable " + TAVILY_API_KEY + " must be set");
        this.restClient = clientBuilder.baseUrl(this.TAVILY_BASE_URL)
